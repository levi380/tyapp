...
import 'package:filbet/widgets/cached_image/image_provider/cached_network_image_provider.dart';
...
class CustomCachedNetworkImage extends StatelessWidget {
  ...
  static Future<bool> evictFromCache(
    ...
    double scale = 1,
    required bool needDecrypt,
  }) async {
    final effectiveCacheManager = cacheManager ?? DefaultCacheManager();
    await effectiveCacheManager.removeFile(cacheKey ?? url);
    return CustomCachedNetworkImageProvider(url,
            scale: scale, needDecrypt: needDecrypt)
        .evict();
  }

  final CustomCachedNetworkImageProvider _image;
  ...
  }) : _image = CustomCachedNetworkImageProvider(
