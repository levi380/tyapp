...
class BottomAlipayManager extends StatelessWidget {
  ValueChanged<bool>? addCard;
  ValueChanged<WalletAccountModel>? deleteCard;
  RxList<WalletAccountModel> accountList = RxList.empty();

  BottomAlipayManager(
      {super.key, required this.accountList, this.addCard, this.deleteCard});
            ...
            MediaQuery.removePadding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return itemView(accountList[index]);
                },
