...
class _GameVenueOverlayState extends State<GameVenueOverlay>
  ...
  Future<void> _dismiss() async {
    ...
    GameListController.to.showGameVenue.value = false; // 再隐藏Widget
  }
                ...
                children: [
                  Container(
                    ...
                    child: GameVenuePanel(
                      type: GameListController.to.categoryType ??
                          CategoryType.video,
                      categories: GlobalService.to.state.allCategoryConfig,
                      onComplete: (type) {
        
                       GameListController.to.onComplete(type);
                      },
                      platform_id: GameListController.to.platform_id ?? "",
