...
GetMatchBaseInfoByMidslEntity $GetMatchBaseInfoByMidslEntityFromJson(
    Map<String, dynamic> json) {
  final GetMatchBaseInfoByMidslEntity getMatchBaseInfoByMidslEntity = GetMatchBaseInfoByMidslEntity();
  final String? code = jsonConvert.convert<String>(json['code']);
  if (code != null) {
    getMatchBaseInfoByMidslEntity.code = code;
  }
  final List<GetMatchBaseInfoByMidslData>? data = (json['data'] as List<
      dynamic>?)?.map(
          (e) =>
      jsonConvert.convert<GetMatchBaseInfoByMidslData>(
          e) as GetMatchBaseInfoByMidslData).toList();
  if (data != null) {
    getMatchBaseInfoByMidslEntity.data = data;
  }
  final String? msg = jsonConvert.convert<String>(json['msg']);
  if (msg != null) {
    getMatchBaseInfoByMidslEntity.msg = msg;
  }
  final int? ts = jsonConvert.convert<int>(json['ts']);
  if (ts != null) {
    getMatchBaseInfoByMidslEntity.ts = ts;
  }
  return getMatchBaseInfoByMidslEntity;
}

Map<String, dynamic> $GetMatchBaseInfoByMidslEntityToJson(
    GetMatchBaseInfoByMidslEntity entity) {
...
extension GetMatchBaseInfoByMidslEntityExtension on GetMatchBaseInfoByMidslEntity {
  GetMatchBaseInfoByMidslEntity copyWith({
    String? code,
    List<GetMatchBaseInfoByMidslData>? data,
    String? msg,
    int? ts,
  }) {
    return GetMatchBaseInfoByMidslEntity()
...
GetMatchBaseInfoByMidslData $GetMatchBaseInfoByMidslDataFromJson(
    Map<String, dynamic> json) {
  final GetMatchBaseInfoByMidslData getMatchBaseInfoByMidslData = GetMatchBaseInfoByMidslData();
  final String? mcid = jsonConvert.convert<String>(json['mcid']);
  if (mcid != null) {
    getMatchBaseInfoByMidslData.mcid = mcid;
  }
  final String? tnjc = jsonConvert.convert<String>(json['tnjc']);
  if (tnjc != null) {
    getMatchBaseInfoByMidslData.tnjc = tnjc;
  }
  final bool? cosTCorner = jsonConvert.convert<bool>(json['cosTCorner']);
  if (cosTCorner != null) {
    getMatchBaseInfoByMidslData.cosTCorner = cosTCorner;
  }
  final String? csna = jsonConvert.convert<String>(json['csna']);
  if (csna != null) {
    getMatchBaseInfoByMidslData.csna = csna;
  }
  final bool? cosTPunish = jsonConvert.convert<bool>(json['cosTPunish']);
  if (cosTPunish != null) {
    getMatchBaseInfoByMidslData.cosTPunish = cosTPunish;
  }
  final bool? cosOutright = jsonConvert.convert<bool>(json['cosOutright']);
  if (cosOutright != null) {
    getMatchBaseInfoByMidslData.cosOutright = cosOutright;
  }
  final dynamic mdsc = json['mdsc'];
  if (mdsc != null) {
    getMatchBaseInfoByMidslData.mdsc = mdsc;
  }
  final int? gcs = jsonConvert.convert<int>(json['gcs']);
  if (gcs != null) {
    getMatchBaseInfoByMidslData.gcs = gcs;
  }
  ...
  final List<dynamic>? hpsOutright = (json['hpsOutright'] as List<dynamic>?)
      ...
      .toList();
  if (hpsOutright != null) {
    getMatchBaseInfoByMidslData.hpsOutright = hpsOutright;
  }
  return getMatchBaseInfoByMidslData;
}

Map<String, dynamic> $GetMatchBaseInfoByMidslDataToJson(
    GetMatchBaseInfoByMidslData entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
extension GetMatchBaseInfoByMidslDataExtension on GetMatchBaseInfoByMidslData {
  GetMatchBaseInfoByMidslData copyWith({
    String? mcid,
    String? tnjc,
    bool? cosTCorner,
    String? csna,
    ...
    String? mat,
    String? mststr,
    List<GetMatchBaseInfoByMidslDataHps>? hps,
    ...
    String? mlet,
    bool? cosPenalty,
    List<GetMatchBaseInfoByMidslDataHpsCorner>? hpsCorner,
    String? mhid,
...
GetMatchBaseInfoByMidslDataHps $GetMatchBaseInfoByMidslDataHpsFromJson(
    Map<String, dynamic> json) {
  final GetMatchBaseInfoByMidslDataHps getMatchBaseInfoByMidslDataHps = GetMatchBaseInfoByMidslDataHps();
  final String? mid = jsonConvert.convert<String>(json['mid']);
  if (mid != null) {
    getMatchBaseInfoByMidslDataHps.mid = mid;
  }
  final String? chpid = jsonConvert.convert<String>(json['chpid']);
  if (chpid != null) {
    getMatchBaseInfoByMidslDataHps.chpid = chpid;
  }
  final String? ctsp = jsonConvert.convert<String>(json['ctsp']);
  if (ctsp != null) {
    getMatchBaseInfoByMidslDataHps.ctsp = ctsp;
  }
  final String? hpid = jsonConvert.convert<String>(json['hpid']);
  if (hpid != null) {
    getMatchBaseInfoByMidslDataHps.hpid = hpid;
  }
  final int? hpon = jsonConvert.convert<int>(json['hpon']);
  if (hpon != null) {
    getMatchBaseInfoByMidslDataHps.hpon = hpon;
  }
  final String? hshow = jsonConvert.convert<String>(json['hshow']);
  if (hshow != null) {
    getMatchBaseInfoByMidslDataHps.hshow = hshow;
  }
  final String? hpn = jsonConvert.convert<String>(json['hpn']);
  if (hpn != null) {
    getMatchBaseInfoByMidslDataHps.hpn = hpn;
  }
  final String? hpnb = jsonConvert.convert<String>(json['hpnb']);
  if (hpnb != null) {
    getMatchBaseInfoByMidslDataHps.hpnb = hpnb;
  }
  final int? hpt = jsonConvert.convert<int>(json['hpt']);
  if (hpt != null) {
    getMatchBaseInfoByMidslDataHps.hpt = hpt;
  }
  final String? hsw = jsonConvert.convert<String>(json['hsw']);
  if (hsw != null) {
    getMatchBaseInfoByMidslDataHps.hsw = hsw;
  }
  final int? hmm = jsonConvert.convert<int>(json['hmm']);
  if (hmm != null) {
    getMatchBaseInfoByMidslDataHps.hmm = hmm;
  }
  final int? hids = jsonConvert.convert<int>(json['hids']);
  if (hids != null) {
    getMatchBaseInfoByMidslDataHps.hids = hids;
  }
  final List<GetMatchBaseInfoByMidslDataHpsHl>? hl = (json['hl'] as List<
      dynamic>?)?.map(
          (e) =>
      jsonConvert.convert<GetMatchBaseInfoByMidslDataHpsHl>(
          e) as GetMatchBaseInfoByMidslDataHpsHl).toList();
  if (hl != null) {
    getMatchBaseInfoByMidslDataHps.hl = hl;
  }
  return getMatchBaseInfoByMidslDataHps;
}

Map<String, dynamic> $GetMatchBaseInfoByMidslDataHpsToJson(
    GetMatchBaseInfoByMidslDataHps entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['mid'] = entity.mid;
...
extension GetMatchBaseInfoByMidslDataHpsExtension on GetMatchBaseInfoByMidslDataHps {
  GetMatchBaseInfoByMidslDataHps copyWith({
    String? mid,
    String? chpid,
    String? ctsp,
    String? hpid,
    ...
    int? hmm,
    int? hids,
    List<GetMatchBaseInfoByMidslDataHpsHl>? hl,
  }) {
    return GetMatchBaseInfoByMidslDataHps()
      ..mid = mid ?? this.mid
...
GetMatchBaseInfoByMidslDataHpsHl $GetMatchBaseInfoByMidslDataHpsHlFromJson(
    Map<String, dynamic> json) {
  final GetMatchBaseInfoByMidslDataHpsHl getMatchBaseInfoByMidslDataHpsHl = GetMatchBaseInfoByMidslDataHpsHl();
  final String? hid = jsonConvert.convert<String>(json['hid']);
  if (hid != null) {
    getMatchBaseInfoByMidslDataHpsHl.hid = hid;
  }
  final int? hs = jsonConvert.convert<int>(json['hs']);
  if (hs != null) {
    getMatchBaseInfoByMidslDataHpsHl.hs = hs;
  }
  final dynamic hv = json['hv'];
  if (hv != null) {
    getMatchBaseInfoByMidslDataHpsHl.hv = hv;
  }
  final int? hmt = jsonConvert.convert<int>(json['hmt']);
  if (hmt != null) {
    getMatchBaseInfoByMidslDataHpsHl.hmt = hmt;
  }
  final dynamic hn = json['hn'];
  if (hn != null) {
    getMatchBaseInfoByMidslDataHpsHl.hn = hn;
  }
  final List<GetMatchBaseInfoByMidslDataHpsHlOl>? ol = (json['ol'] as List<
      dynamic>?)?.map(
          (e) =>
      jsonConvert.convert<GetMatchBaseInfoByMidslDataHpsHlOl>(
          e) as GetMatchBaseInfoByMidslDataHpsHlOl).toList();
  if (ol != null) {
    getMatchBaseInfoByMidslDataHpsHl.ol = ol;
  }
  return getMatchBaseInfoByMidslDataHpsHl;
}

Map<String, dynamic> $GetMatchBaseInfoByMidslDataHpsHlToJson(
    GetMatchBaseInfoByMidslDataHpsHl entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['hid'] = entity.hid;
  data['hs'] = entity.hs;
  data['hv'] = entity.hv;
...
extension GetMatchBaseInfoByMidslDataHpsHlExtension on GetMatchBaseInfoByMidslDataHpsHl {
  GetMatchBaseInfoByMidslDataHpsHl copyWith({
    String? hid,
    int? hs,
    dynamic hv,
    int? hmt,
    dynamic hn,
    List<GetMatchBaseInfoByMidslDataHpsHlOl>? ol,
  }) {
    return GetMatchBaseInfoByMidslDataHpsHl()
      ..hid = hid ?? this.hid
      ..hs = hs ?? this.hs
...
GetMatchBaseInfoByMidslDataHpsHlOl $GetMatchBaseInfoByMidslDataHpsHlOlFromJson(
    Map<String, dynamic> json) {
  final GetMatchBaseInfoByMidslDataHpsHlOl getMatchBaseInfoByMidslDataHpsHlOl = GetMatchBaseInfoByMidslDataHpsHlOl();
  final String? oid = jsonConvert.convert<String>(json['oid']);
  if (oid != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.oid = oid;
  }
  final int? os = jsonConvert.convert<int>(json['os']);
  if (os != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.os = os;
  }
  final int? otd = jsonConvert.convert<int>(json['otd']);
  if (otd != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.otd = otd;
  }
  final String? ot = jsonConvert.convert<String>(json['ot']);
  if (ot != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.ot = ot;
  }
  final dynamic dov = json['dov'];
  if (dov != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.dov = dov;
  }
  final dynamic doc = json['doc'];
  if (doc != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.doc = doc;
  }
  final int? ov = jsonConvert.convert<int>(json['ov']);
  if (ov != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.ov = ov;
  }
  final dynamic ov2 = json['ov2'];
  if (ov2 != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.ov2 = ov2;
  }
  final String? on = jsonConvert.convert<String>(json['on']);
  if (on != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.on = on;
  }
  final String? onb = jsonConvert.convert<String>(json['onb']);
  if (onb != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.onb = onb;
  }
  final String? cds = jsonConvert.convert<String>(json['cds']);
  if (cds != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.cds = cds;
  }
  final String? ots = jsonConvert.convert<String>(json['ots']);
  if (ots != null) {
    getMatchBaseInfoByMidslDataHpsHlOl.ots = ots;
  }
  return getMatchBaseInfoByMidslDataHpsHlOl;
}

Map<String, dynamic> $GetMatchBaseInfoByMidslDataHpsHlOlToJson(
    GetMatchBaseInfoByMidslDataHpsHlOl entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['oid'] = entity.oid;
  data['os'] = entity.os;
  data['otd'] = entity.otd;
...
extension GetMatchBaseInfoByMidslDataHpsHlOlExtension on GetMatchBaseInfoByMidslDataHpsHlOl {
  GetMatchBaseInfoByMidslDataHpsHlOl copyWith({
    String? oid,
    int? os,
    int? otd,
    String? ot,
...
GetMatchBaseInfoByMidslDataHpsCorner $GetMatchBaseInfoByMidslDataHpsCornerFromJson(
    Map<String, dynamic> json) {
  final GetMatchBaseInfoByMidslDataHpsCorner getMatchBaseInfoByMidslDataHpsCorner = GetMatchBaseInfoByMidslDataHpsCorner();
  final String? mid = jsonConvert.convert<String>(json['mid']);
  if (mid != null) {
    getMatchBaseInfoByMidslDataHpsCorner.mid = mid;
  }
  final String? chpid = jsonConvert.convert<String>(json['chpid']);
  if (chpid != null) {
    getMatchBaseInfoByMidslDataHpsCorner.chpid = chpid;
  }
  final String? ctsp = jsonConvert.convert<String>(json['ctsp']);
  if (ctsp != null) {
    getMatchBaseInfoByMidslDataHpsCorner.ctsp = ctsp;
  }
  final String? hpid = jsonConvert.convert<String>(json['hpid']);
  if (hpid != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hpid = hpid;
  }
  final int? hpon = jsonConvert.convert<int>(json['hpon']);
  if (hpon != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hpon = hpon;
  }
  final String? hshow = jsonConvert.convert<String>(json['hshow']);
  if (hshow != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hshow = hshow;
  }
  final String? hpn = jsonConvert.convert<String>(json['hpn']);
  if (hpn != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hpn = hpn;
  }
  final String? hpnb = jsonConvert.convert<String>(json['hpnb']);
  if (hpnb != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hpnb = hpnb;
  }
  final int? hpt = jsonConvert.convert<int>(json['hpt']);
  if (hpt != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hpt = hpt;
  }
  final String? hsw = jsonConvert.convert<String>(json['hsw']);
  if (hsw != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hsw = hsw;
  }
  final int? hmm = jsonConvert.convert<int>(json['hmm']);
  if (hmm != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hmm = hmm;
  }
  final int? hids = jsonConvert.convert<int>(json['hids']);
  if (hids != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hids = hids;
  }
  final List<GetMatchBaseInfoByMidslDataHpsCornerHl>? hl = (json['hl'] as List<
      dynamic>?)?.map(
          (e) =>
      jsonConvert.convert<GetMatchBaseInfoByMidslDataHpsCornerHl>(
          e) as GetMatchBaseInfoByMidslDataHpsCornerHl).toList();
  if (hl != null) {
    getMatchBaseInfoByMidslDataHpsCorner.hl = hl;
  }
  return getMatchBaseInfoByMidslDataHpsCorner;
}

Map<String, dynamic> $GetMatchBaseInfoByMidslDataHpsCornerToJson(
    GetMatchBaseInfoByMidslDataHpsCorner entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['mid'] = entity.mid;
  data['chpid'] = entity.chpid;
  data['ctsp'] = entity.ctsp;
...
extension GetMatchBaseInfoByMidslDataHpsCornerExtension on GetMatchBaseInfoByMidslDataHpsCorner {
  GetMatchBaseInfoByMidslDataHpsCorner copyWith({
    String? mid,
    String? chpid,
    String? ctsp,
    String? hpid,
    ...
    int? hmm,
    int? hids,
    List<GetMatchBaseInfoByMidslDataHpsCornerHl>? hl,
  }) {
    return GetMatchBaseInfoByMidslDataHpsCorner()
      ..mid = mid ?? this.mid
      ..chpid = chpid ?? this.chpid
...
GetMatchBaseInfoByMidslDataHpsCornerHl $GetMatchBaseInfoByMidslDataHpsCornerHlFromJson(
    Map<String, dynamic> json) {
  final GetMatchBaseInfoByMidslDataHpsCornerHl getMatchBaseInfoByMidslDataHpsCornerHl = GetMatchBaseInfoByMidslDataHpsCornerHl();
  return getMatchBaseInfoByMidslDataHpsCornerHl;
}

Map<String, dynamic> $GetMatchBaseInfoByMidslDataHpsCornerHlToJson(
    GetMatchBaseInfoByMidslDataHpsCornerHl entity) {
  final Map<String, dynamic> data = <String, dynamic>{};
  return data;
}

extension GetMatchBaseInfoByMidslDataHpsCornerHlExtension on GetMatchBaseInfoByMidslDataHpsCornerHl {
}