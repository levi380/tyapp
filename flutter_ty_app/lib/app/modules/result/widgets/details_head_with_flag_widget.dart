...
import 'package:flutter_ty_app/app/modules/result/widgets/details_head_score_widget.dart';
...
import 'details_head_team_widget.dart';
import 'dart:math';
 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 赛果详情  头部组件  DetailsHeadWidget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 赛果详情  头部组件  DetailsHeadWidget
    - DetailsHeadWidget
    】】】
 *
 */
class DetailsHeadWithFlagWidget extends StatelessWidget {
  const DetailsHeadWithFlagWidget({
    super.key,
                ...
                Row(
                  ...
                  children: [
                    SizedBox(
                      ...
                      child:  DetailsHeadTeamWidget(detailData: detailData, isHomeTeam: true),
                    ),
                    Expanded(
                      child: OverflowBox(
                        alignment: Alignment.topCenter,
                        maxWidth: double.infinity,
                        child: DetailsHeadScoreWidget(detailData: detailData, headerMap: headerMap),
                        // Container(
                        ...
                        //     crossAxisAlignment: CrossAxisAlignment.center,
                        //     children: [
                        //       SizedBox(height: isIPad ? 28.h : 28.h),
                        //       // 比赛分数or开赛时间
                        //       Column(
                        //         children: [
                        //           if (detailData != null)
                    ...
                    SizedBox(
                      width: isIPad ? 300.w : 151.5.w,
                      child: DetailsHeadTeamWidget(detailData: detailData, isHomeTeam: false),
                    ),
                  ],
                ),
              ),
