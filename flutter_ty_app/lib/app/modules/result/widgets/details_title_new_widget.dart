 ...
 *
 */
class DetailsTitleNewWidget extends StatelessWidget {
  const DetailsTitleNewWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return  headMatchListTitle.isNotEmpty ? Container(
      ...
      child: Column(
        children: [
                      ...
                      Expanded(
                        ...
                        child: Row(
                          children: [
                            ...
                            titleIndex == 1 ?
                            ImageView(
                              headMatchListTitle[0].mhlu[0].toString().isEmpty ? 'assets/images/detail/home_team_logo.svg': headMatchListTitle[0].mhlu[0],
                              dj: true,
                              width: 28.w,
                              height: 28.w,
                      ...
                      Expanded(
                        ...
                        child: Row(
                          children: [
                            ...
                            titleIndex == 1 ?
                            ImageView(
                              headMatchListTitle[0].malu[0].toString().isEmpty ? 'assets/images/detail/default_team_away.svg': headMatchListTitle[0].malu[0],
                              dj: true,
                              width: 28.w,
                              height: 28.w,
                              errorWidget: ImageView(
          ...
          if(headMatchListNew.isNotEmpty)
            Container(
              height: 36.h,
              ...
              child: Container(
                ...
                child: Text(
                  detailData!.tn+'(${headMatchListNew.length.toString()})',
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(
                                        ...
                                        Row(
                                          children: [
                                                ...
                                                child: Text(
                                                  ...
                                                  DateUtil.formatDateMs(
                                                      TimeZoneUtils.convertTimeToTimestamp(headMatchListNew[index].mgt,
                                                          isMilliseconds: true,
                                                          returnMilliseconds:true)?? 0, format:LocaleKeys.time11.tr,   isUtc: true)+"("+TimeZoneUtils.getTimeZoneString()+")",
                                                  style: TextStyle(
                                            ...
                                            DetailsTitleNewScoreWidget(
                                              ...
                                              image: headMatchListNew[index].mhlu[0].toString().isEmpty ? 'assets/images/detail/home_team_logo.svg': headMatchListNew[index].mhlu[0],
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            DetailsTitleNewScoreWidget(
                                              isDark: isDark,
                                              titleIndex: titleIndex,
                                              image: headMatchListNew[index].malu[0].toString().isEmpty ? 'assets/images/detail/home_team_logo.svg': headMatchListNew[index].malu[0],
