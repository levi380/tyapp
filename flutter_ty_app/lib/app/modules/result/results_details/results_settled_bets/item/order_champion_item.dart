...
import 'package:flutter_ty_app/app/modules/unsettled_bets/widgets/information_title_view.dart';
 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 赛果体育注单-冠军(已结算/未结算)item视图层 】】】
  ...
  String getplayOptionName() {
    ...
    if (data.detailList.isNotEmpty) {
      if (data.seriesType == '100') {
        ...
        playOptionName =
        "${data.detailList[0].playOptionName} @${data.detailList[0]
            .oddFinally}";
      }
    }
