 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE  VR赛果 足球赛事筛选头部组件 VrZqItemSubTitleWidget 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    -  VR赛果 足球赛事筛选头部组件 VrZqItemSubTitleWidget
    - VrZqItemSubTitleWidget
    ```
    ///足球赛事筛选头部组件
    VrZqItemSubTitleWidget(
      isDark: isDark,
...
class VrZqItemSubTitleWidget extends StatelessWidget {
  const VrZqItemSubTitleWidget({
    super.key,
