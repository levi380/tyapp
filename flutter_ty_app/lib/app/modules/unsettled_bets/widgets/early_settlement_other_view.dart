  ...
  Widget _showDifferentStyles(int earlySettlementType) {
    ...
    if (data.earlySettlementType == 0) {
      return EarlyAppointmentSettlementView(
        data: data,
        unsettledBetsLogic: unsettledBetsLogic,
        index: index,
      );
      ...
      child: InkWell(
        onTap: () => {
          if (data.earlySettlementType != type)
            {
              unsettledBetsLogic.setType(index, type),
            }
        },
        child: Column(
            ...
            Text(
              ...
              style: TextStyle(
                color: context.isDarkMode
                    ? Colors.white.withValues(alpha:type == data.earlySettlementType
                        ? 0.8999999761581421
                        : 0.5)
                    : Color(type == data.earlySettlementType
                        ? 0xFF303442
                        : 0xFF7981A3),
                fontSize: 12.sp,
