...
class InformationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Color> listColor = [
       Color(0xFF303442),
       Color(0xFFAFB3C8),
      isFootballBasketballTemplate ? HexColor(footballBasketballTemplateThemeColor) : Color(0xFF179CFF),
       Color(0xFFF53F3F)
    ];
    if (context.isDarkMode) {
      listColor[0] = Colors.white.withValues(alpha:0.8999999761581421);
      listColor[2] =  isFootballBasketballTemplate ? HexColor(footballBasketballTemplateThemeColor) : const Color(0xFF127DCC);
    }
    return Container(
