...
import '../../group_bet/bets/widgets/dividing_line_view.dart';
import '../utils/betsUtils.dart';
import 'early_settlement_other_view.dart';
...
class EarlySettlementFeatureView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ///分割线
        const DividingLineView().marginOnly(bottom: 4.h),
        ///提前兑现失败提示语
        ...
        SizedBox(
          ...
          ///如果已经提前结算过，高度增高一些
        //  height: getPreSettleBetAmount().isNotEmpty ? 50.h : 44.h,
          height:  50.h,
          child: Row(
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: isFootballBasketballTemplate ? HexColor(footballBasketballTemplateThemeColor) :Color(context.isDarkMode ? 0xFF127DCC : 0xff179CFF),
                  fontSize: 12.sp,
                  fontFamily: 'PingFang SC',
                  fontWeight: FontWeight.w400,
                ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: ShapeDecoration(
          color: isFootballBasketballTemplate ? HexColor(footballBasketballTemplateThemeColor) : context.isDarkMode
        ...
        child: ImageView(
          ...
          color: data.earlySettlementState == 2
              ? Colors.white
              : isFootballBasketballTemplate ? Colors.white :Color(context.isDarkMode ? 0xFF127DCC : 0xFF179CFF),
        ),
      ),
    );
  }
  ...
  String getCashout() {
    ...
    if (data.earlySettlementState == 2 && data.earlySettlementType == 1) {
      cashout = BetsUtils.getExpectedProfit(logic.state.listData[index]);
    } else {
