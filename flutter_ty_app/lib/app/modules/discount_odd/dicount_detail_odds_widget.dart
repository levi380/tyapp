...
/// 优惠赔率
class discountDetailOddssWidget extends StatefulWidget {
  const discountDetailOddssWidget({
    super.key,
    required this.ol,
    required this.match,
    required this.hps,
  ...
  @override
  State<discountDetailOddssWidget> createState() =>
      _discountDetailOddssWidgetState();
}

class _discountDetailOddssWidgetState extends State<discountDetailOddssWidget> {
  @override
  ...
  ArrowWidget() {
    if (status == 10 || status2 == 10) {
      ...
      //     width: widgets.fullscreen ? 12 : 12.w,
      //   );
    }
  }
