...
import 'package:flutter_ty_app/app/modules/bet_ty_cp_zr/ty/bets/widgets/cross_checks_titles_view.dart';
import 'package:flutter_ty_app/app/modules/unsettled_bets/widgets/multiple_together_view.dart';
  ...
  _earlyRedemptionView() {
    return Column(
      children: [
        ...
        if (getExhibitEarlySettlement() && type == 1)
