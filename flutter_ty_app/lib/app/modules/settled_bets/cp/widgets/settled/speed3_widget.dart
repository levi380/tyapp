 ...
 *
 */
class Speed3Widget extends StatelessWidget {
  ...
  final List<String> imgData = ['one1', 'two', 'three', 'four', 'five', 'six'];
  @override
    ...
    return (data.isEmpty || orderListItem.ticketResult?.isEmpty == true)
        ...
        : Container(
            ...
            child: Row(
              ...
              children: data.map((e) {
                // AppLogger.debug("=======+> e  ${e}  ${ 'assets/images/cp_ticket_bg/${context.isDarkMode ? 'night' : 'day'}/${(imgData[((int.tryParse(e)??1)-1)])}.png'}");
                return Container(
                  width: 20.w,
                  height: 20.w,
                    ...
                    image: DecorationImage(
                      image: NetworkImage(
                        OssUtil.getServerPath(
                            'assets/images/cp_ticket_bg/${context.isDarkMode ? 'night' : 'day'}/${imgData[(int.tryParse(e) ?? 0) - 1]}.png'),
                      ),
                      fit: BoxFit.cover,
                    ),
                  ),
