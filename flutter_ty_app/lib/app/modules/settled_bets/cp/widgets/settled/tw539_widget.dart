 ...
 *
 */
class Tw539Widget extends StatelessWidget {
  ...
  initData() {
    ...
    index = [2024, 2025, 2026, 2027].indexOf(year ?? 0);
    newArray.clear();
    newArray.addAll(sxNumArray539.sublist(3 - (index ?? 0)));
    newArray.addAll(sxNumArray539.sublist(0, 3 - (index ?? 0)));
