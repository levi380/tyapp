 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 体育串关投注注单Widget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 体育串关投注注单，注单类型为体育时显示
    】】】
 *
 */
class BetItemTyMix extends StatelessWidget with BetItemCpNumberTimeMixin {
  BetItemTyMix(this.orderItem, this.isExpanded, this.isMixExpanded,this.index,
      {super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...orderItem.detailList
                      .map((e) => _buildOrderItem(context, e))
                      .toList(),
                ],
              ),
            ),
  ...
  Widget _buildOrderItem(BuildContext context,
      GetH5OrderListDataRecordxDataDetailList orderMixItem) {
    ThemeData themeData = Theme.of(context);
  ...
  String getMatchType(GetH5OrderListDataRecordxDataDetailList mixItem) {
    String matchType = '';
