 ...
 *
 */
class ComboCourageBetResultView extends StatelessWidget {
  ComboCourageBetResultView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    for(BetResultOrderDetailRespList item in logic.orderRespList){
  ...
  Widget _buildConfirmButton(BuildContext context){
    ...
    bool isButtonDiabled = logic.betStatus.value == ShopCartBetStatus.Betting || logic.betStatus.value == ShopCartBetStatus.Prebooking || logic.betStatus.value == ShopCartBetStatus.Failure;
    return Column(
      children: [
        if(betResultOrder.riskEvent!=null)
          ...
          _buildFinishButton(context,LocaleKeys.app_h5_bet_confirm.tr,isButtonDiabled
