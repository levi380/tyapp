...
import '../single_bet/single_bet_result_view.dart';
import '../single_bet/single_prebook/single_prebook_view.dart';
 ...
 *
 */
class MixSingleBetComponent<T extends BaseBetController> extends StatelessWidget {
  MixSingleBetComponent({Key? key}) : super(key: key);
  ...
  Widget _buildInputWidget(BuildContext context){
    ...
    return GetBuilder<T>(
        ...
        builder: (controller)
        {
          FocusNode focusNode = logic.amountFocusNodeSingle;
          TextEditingController textEditingController =
              logic.amountControllerSingle;
          return Container(
