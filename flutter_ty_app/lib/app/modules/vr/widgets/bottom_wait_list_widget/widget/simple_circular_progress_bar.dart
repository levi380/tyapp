...
/// redrawing of the widgets. Animation transition to a new value already built
/// into the widgets. Progress bar can be either with or without a gradient.
class SimpleCircularProgressBar extends StatefulWidget {
  // 默认顺时针
  final bool clockwise;

  /// Widget size. Equals the height and width of the widgets.
  final double size;
  ...
  /// Callback to generate a new Text widgets located in the center of the
  ...
  /// The values are updated with ValueNotifier which helps to avoid unnecessary
  /// redrawing of the widgets and also allows you to put animation inside the
  /// widgets.
  ///
  ...
  /// you should return the Text widgets for the current progress bar value.
...
class SimpleCircularProgressBarState extends State<SimpleCircularProgressBar>
  ...
  void initState() {
    ...
    // Check zero size.
    widgetSize = (widget.size <= 0) ? 100.0.w : widget.size;
    maxValue = (widget.maxValue <= 0) ? 100.0.w : widget.maxValue;
      ...
      builder: (BuildContext context, double value, Widget? child) {
        ...
        return AnimatedBuilder(
          ...
          builder: (context, snapshot) {
            ...
            // Create center text widgets.
            // If no callback is defined, create an empty widgets.
            ...
            return Stack(
              ...
              children: [
                centerTextWidget,
                Transform.rotate(
                  angle: _degToRad(widget.startAngle - 90.w),
