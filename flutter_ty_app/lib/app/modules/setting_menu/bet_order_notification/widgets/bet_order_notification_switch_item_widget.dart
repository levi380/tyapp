 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 设置菜单 注单通知 列表组件 BetOrderNotificationSwitchButtonWidget 】】】
...
class BetOrderNotificationSwitchItemWidget extends StatelessWidget {
  const BetOrderNotificationSwitchItemWidget({
    super.key,
    required this.title,
