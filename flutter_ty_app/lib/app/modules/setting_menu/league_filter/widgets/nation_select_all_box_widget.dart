 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 联赛筛选  搜索全选按钮组件 NationSelectAllBoxWidget  】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 联赛筛选  搜索全选按钮组件 NationSelectAllBoxWidget
...
class NationSelectAllBoxWidget extends StatelessWidget {
  const NationSelectAllBoxWidget({
    super.key,
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              getFilterMatchListData.isNotEmpty
                  ? InkWell(
                      onTap: onSelectAll,
                      child: Row(
                        children: [
