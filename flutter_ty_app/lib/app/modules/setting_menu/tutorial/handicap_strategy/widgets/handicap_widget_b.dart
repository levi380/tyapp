...
import 'handicap_widget_b_1.dart';
 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 盘口教程 让球攻略 0/0.5球 HandicapBWidget 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 盘口教程 让球攻略 0/0.5球 HandicapBWidget
    - HandicapBWidget
    ```
    /// 0/0.5球
    HandicapBWidget(
 ...
 *
 */
class HandicapBWidget extends StatelessWidget {
  const HandicapBWidget({
    super.key,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            HandicapB1Widget(isDark:isDark,index:index),
          ],
        ),
      ),
    );
