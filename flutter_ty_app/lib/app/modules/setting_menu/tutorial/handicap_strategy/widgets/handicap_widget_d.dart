...
import 'handicap_widget_d_1.dart';
 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 盘口教程 让球攻略 0.5/1 球 HandicapDWidget 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 盘口教程 让球攻略 0.5/1 球 HandicapDWidget
    - HandicapDWidget
    ```
    ///  0.5/1 球
    HandicapDWidget(
 ...
 *
 */
class HandicapDWidget extends StatelessWidget {
  const HandicapDWidget({
    super.key,
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          LocaleKeys
                              .app_h5_handicap_tutorial_home_team_handicap.tr
                              .replaceAll('%s', '0.5/1'),
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            color: isDark
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: ShapeDecoration(
                        ...
                        shape: RoundedRectangleBorder(
                          side: BorderSide(
                              width: 0.50.w, color: const Color(0x1900B42A)),
                          borderRadius: BorderRadius.circular(6),
                        ),
                      ),
                      child: Container(
