 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 盘口教程 让球攻略 0球 HandicapAWidget 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 盘口教程 让球攻略 0球 HandicapAWidget
    - HandicapAWidget
    ```
    /// 0球
    HandicapAWidget(
 ...
 *
 */
class HandicapA1Widget extends StatelessWidget {
  const HandicapA1Widget({
    super.key,
              ...
              children: [
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    alignment: Alignment.center,
                    child: Text(
                      LocaleKeys.app_h5_handicap_tutorial_return_principal.tr,
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: isDark
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      LocaleKeys
                          .app_h5_handicap_tutorial_handicapData_condition.tr,
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: isDark
