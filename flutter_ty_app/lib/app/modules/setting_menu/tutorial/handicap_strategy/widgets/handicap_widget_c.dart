...
import 'handicap_widget_c_1.dart';
 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 盘口教程 让球攻略 0.5球 HandicapCWidget 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 盘口教程 让球攻略 0.5球 HandicapCWidget
    - HandicapCWidget
    ```
    ///  0.5球
    HandicapCWidget(
 ...
 *
 */
class HandicapCWidget extends StatelessWidget {
  const HandicapCWidget({
    super.key,
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            HandicapC1Widget(index: index,isDark: isDark,)
          ],
        ),
      ),
    );
