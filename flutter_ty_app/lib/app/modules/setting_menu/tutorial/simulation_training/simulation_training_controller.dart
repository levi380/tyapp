 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 大小球模拟训练 控制器 SimulationTrainingController 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 大小球模拟训练 控制器  SimulationTrainingController
    - SimulationTrainingController
    ```
    ///模拟训练答题 1
    bool question1 = true;
...
class SimulationTrainingController extends GetxController {
  ...
  ///下一题
  nextQuestion() {
    logic.question1 = false;
    logic.select = 0;
    logic.question2 = true;
    update();
  }
}
