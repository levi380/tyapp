...
import 'one_click_number_keyboard.dart';
 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 一键投注 一键投注金额设置 组件  OneClickCustomAmountWidget 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 一键投注 一键投注金额设置 组件 OneClickCustomAmountWidget
    - OneClickCustomAmountWidget
    ```
    ///一键投注金额设置
    OneClickCustomAmountWidget(
 ...
 *
 */
class OneClickCustomAmountWidget extends StatelessWidget {
  const OneClickCustomAmountWidget({
    super.key,
