 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 一键投注 OneClickMenuWidget 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 一键投注 OneClickMenuWidget
    ```
    OneClickMenuWidget(
      onTap: () => controller.onOneClickBetting(),
      title: LocaleKeys.bet_one_click_bet.tr,
      isDark: controller.isDarkMode,
      fastBetAmount: controller.fastBetAmount,
      dividing: true,
      bigFontSize: true,
 ...
 *
 */
class OneClickMenuWidget extends StatelessWidget {
  const OneClickMenuWidget({
    super.key,
    required this.title,
    this.onTap,
