 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE 年报 7 号模版 Report7Widget 】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 年报 7 号模版 Report7Widget
    - Report7Widget
    ```
    Report7Widget(
      Template:Template,
...
class Report7Widget extends StatelessWidget {
  Report7Widget({
    super.key,
    ...
    content = content
        .replaceAll(
            ...
            '%h' +
                ...
                '%h')
        .replaceAll('%sannualMaxSettleAmount%s',
            '%h' + annualReportController.logic.annualMaxSettleAmount + '%h')
        .replaceAll(
            '%sannualMaxSettleAmountPercentRank%s',
            '%h' +
                annualReportController.logic.annualMaxSettleAmountPercentRank +
                '%%h')
        .replaceAll('%s$annualMaxSettleCurrency%s',
            '%h' + annualReportController.logic.annualMaxSettleCurrency + '%h');
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                            children: _getStyledText(content, [
                                              annualMaxBetAmountCreateTime,
                                          annualReportController
                                              .logic.annualMaxSettleAmount,
                                          annualReportController
                                                  .logic.annualMaxSettleAmountPercentRank +
                                              "%",
                                          annualReportController
                                              .logic.annualMaxSettleCurrency
                                        ])),
                                      ),
                                    ),
                                  );
