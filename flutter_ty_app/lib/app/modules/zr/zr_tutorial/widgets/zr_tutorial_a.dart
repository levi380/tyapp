 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE  游戏规则 ZrTutorialAWidget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 游戏规则 ZrTutorialAWidget
    - ZrTutorialAWidget
    ```
    ///游戏规则
    ZrTutorialAWidget(
 ...
 *
 */
class ZrTutorialAWidget extends StatelessWidget {
  const ZrTutorialAWidget({
    super.key,
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Text(
                        LocaleKeys.zr_cp_footer_menu_zr_zrtext_0_0.tr,
                        style: TextStyle(
                          color: isDark
                    ...
                    Container(
                      ...
                      alignment: Alignment.centerLeft,
                      child: Text(
                        LocaleKeys.zr_cp_footer_menu_zr_zrtext_0_1.tr,
                        style: TextStyle(
                          color: isDark
                              ? Colors.white.withValues(alpha:0.5)
                              : const Color(0xFF8D8D8D),
                    ...
                    Container(
                      ...
                      alignment: Alignment.centerLeft,
                      child: Text(
                        LocaleKeys.zr_cp_footer_menu_zr_zrtext_0_2.tr,
                        style: TextStyle(
                          color: isDark
                              ? Colors.white.withValues(alpha:0.5)
                              : const Color(0xFF8D8D8D),
                    ...
                    Container(
                      ...
                      alignment: Alignment.centerLeft,
                      child: Text(
                        LocaleKeys.zr_cp_footer_menu_zr_zrtext_0_3.tr,
                        style: TextStyle(
                          color: isDark
                              ? Colors.white.withValues(alpha:0.5)
                              : const Color(0xFF8D8D8D),
