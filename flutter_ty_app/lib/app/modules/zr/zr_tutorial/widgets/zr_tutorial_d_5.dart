 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE  玩法判定 超级对 ZrTutorialD5Widget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 玩法判定 超级对 ZrTutorialD5Widget
    - ZrTutorialD5Widget
    ```
    ///5.超级对
    ZrTutorialD5Widget(
 ...
 *
 */
class ZrTutorialD5Widget extends StatelessWidget {
  const ZrTutorialD5Widget({
    super.key,
    ...
    return Column(
      children: [
        Container(
          ...
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents18.tr,
            style: TextStyle(
              color: isDark
        ...
        Container(
          ...
          alignment: Alignment.centerLeft,
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents19.tr,
            style: TextStyle(
              color: isDark
        ...
        Container(
          height: Get.locale!.toLanguageTag().contains('zh-CN')|| Get.locale!.toLanguageTag().contains('zh-TW') ? 110.h : 180.h,
          margin: EdgeInsets.only(
            top: 10.h,
          ),
          child: Row(
