 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE  玩法判定 熊猫8 ZrTutorialD7Widget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 玩法判定 熊猫8 ZrTutorialD7Widget
    - ZrTutorialD7Widget
    ```
    ///7.熊猫8
    ZrTutorialD7Widget(
 ...
 *
 */
class ZrTutorialD7Widget extends StatelessWidget {
  const ZrTutorialD7Widget({
    super.key,
    ...
    return Column(
      children: [
        Container(
          ...
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents22.tr,
            style: TextStyle(
              color: isDark
        ...
        Container(
          ...
          alignment: Alignment.centerLeft,
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents23.tr,
            style: TextStyle(
              color: isDark
