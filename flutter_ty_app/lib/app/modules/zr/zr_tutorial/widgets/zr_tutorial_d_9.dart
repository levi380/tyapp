 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE  玩法判定 老虎和 ZrTutorialD9Widget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 玩法判定 老虎和 ZrTutorialD9Widget
    - ZrTutorialD9Widget
    ```
    ///9.老虎和
    ZrTutorialD9Widget(
 ...
 *
 */
class ZrTutorialD9Widget extends StatelessWidget {
  const ZrTutorialD9Widget({
    super.key,
    ...
    return Column(
      children: [
        Container(
          ...
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents27.tr,
            style: TextStyle(
              color: isDark
        ...
        Container(
          ...
          alignment: Alignment.centerLeft,
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents28.tr,
            style: TextStyle(
              color: isDark
