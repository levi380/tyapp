...
import 'package:flutter_ty_app/app/modules/zr/zr_tutorial/widgets/zr_tutorial_d_17_b.dart';
...
class ZrTutorialD17AWidget extends StatelessWidget {
  const ZrTutorialD17AWidget({
    super.key,
    ...
    return Column(
      children: [
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: isDark
                                      ...
                                      : const Color(0xFF333333),
                                  fontSize:
                                      TyTextScaler.instance().scale(16.sp),
                                  fontFamily: 'PingFang SC',
        ...
        Container(
          ...
          alignment: Alignment.centerLeft,
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents61.tr,
            style: TextStyle(
              color: isDark
                  ? Colors.white.withValues(alpha: 0.5)
                  : const Color(0xFF8D8D8D),
        ...
        ZrTutorialD17BWidget(isDark: isDark),
        Container(
          margin: EdgeInsets.only(
            top: 10.h,
          ),
          alignment: Alignment.centerLeft,
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents62.tr,
            style: TextStyle(
              color: isDark
                  ? Colors.white.withValues(alpha: 0.5)
                  : const Color(0xFF8D8D8D),
