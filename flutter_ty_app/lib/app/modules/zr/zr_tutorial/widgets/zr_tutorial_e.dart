...
import 'package:flutter_ty_app/app/modules/zr/zr_tutorial/widgets/zr_tutorial_e_1.dart';
import 'package:flutter_ty_app/app/modules/zr/zr_tutorial/widgets/zr_tutorial_e_2.dart';
 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE  赔率表 ZrTutorialEWidget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 赔率表 ZrTutorialEWidget
    - ZrTutorialEWidget
    ```
    ///赔率表
    ZrTutorialEWidget(
...
class ZrTutorialEWidget extends StatelessWidget {
  const ZrTutorialEWidget({
    super.key,
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Text(
                        LocaleKeys.zr_cp_footer_menu_zr_zrtext_4_contents0.tr,
                        style: TextStyle(
                          color: isDark
