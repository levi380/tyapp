 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE  玩法判定 龙7 ZrTutorialD6Widget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 玩法判定 龙7 ZrTutorialD6Widget
    - ZrTutorialD6Widget
    ```
    ///6.龙7
    ZrTutorialD6Widget(
 ...
 *
 */
class ZrTutorialD6Widget extends StatelessWidget {
  const ZrTutorialD6Widget({
    super.key,
    ...
    return Column(
      children: [
        Container(
          ...
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents20.tr,
            style: TextStyle(
              color: isDark
        ...
        Container(
          ...
          alignment: Alignment.centerLeft,
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents21.tr,
            style: TextStyle(
              color: isDark
