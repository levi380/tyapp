...
import 'package:flutter_ty_app/app/modules/zr/zr_tutorial/widgets/zr_tutorial_d_13_a.dart';
 ...
 *
    ...
    【【【 AUTO_PARAGRAPH_TITLE  玩法判定 龙&虎&和 ZrTutorialD13Widget】】】
    【【【 AUTO_PARAGRAPH_CONTENT
    - 玩法判定 龙&虎&和 ZrTutorialD13Widget
    - ZrTutorialD13Widget
    ```
    ///13.龙&虎&和
    ZrTutorialD13Widget(
 ...
 *
 */
class ZrTutorialD13Widget extends StatelessWidget {
  const ZrTutorialD13Widget({
    super.key,
    ...
    return Column(
      children: [
        Container(
          ...
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents40.tr,
            style: TextStyle(
              color: isDark
        ...
        Container(
          ...
          alignment: Alignment.centerLeft,
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents41.tr,
            style: TextStyle(
              color: isDark
        ...
        Container(
          ...
          alignment: Alignment.centerLeft,
          child: Text(
            LocaleKeys.zr_cp_footer_menu_zr_zrtext_3_contents42.tr,
            style: TextStyle(
              color: isDark
                  ? Colors.white.withValues(alpha: 0.5)
                  : const Color(0xFF8D8D8D),
        ...
        ZrTutorialD13AWidget(isDark: isDark),
      ],
    );
  }
}
