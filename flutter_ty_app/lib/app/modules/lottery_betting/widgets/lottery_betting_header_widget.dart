...
class LotteryBettingHeaderWidget extends StatefulWidget {
  const LotteryBettingHeaderWidget({super.key, required this.onValueChanged});

  final ValueChanged<MainMenu> onValueChanged;

  @override
  State<LotteryBettingHeaderWidget> createState() =>
      _LotteryBettingHeaderWidgetState();
}

class _LotteryBettingHeaderWidgetState
    extends State<LotteryBettingHeaderWidget> {
