...
///赛事类型菜单
class LotteryBettingMainMenuWidget extends StatefulWidget {
  const LotteryBettingMainMenuWidget({super.key, required this.onValueChanged});

  final ValueChanged<MainMenu> onValueChanged;

  @override
  State<LotteryBettingMainMenuWidget> createState() =>
      _LotteryBettingMainMenuWidgetState();
}

class _LotteryBettingMainMenuWidgetState
    extends State<LotteryBettingMainMenuWidget> {
