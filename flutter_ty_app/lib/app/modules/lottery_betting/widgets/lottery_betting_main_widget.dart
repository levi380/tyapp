...
class LotteryBettingMainWidget extends StatefulWidget {
  const LotteryBettingMainWidget({super.key, required this.onValueChanged});

  final ValueChanged<MainMenu> onValueChanged;

  @override
  State<LotteryBettingMainWidget> createState() =>
      _LotteryBettingMainWidgetState();
}

class _LotteryBettingMainWidgetState
    extends State<LotteryBettingMainWidget> {
