...
///赛事类型菜单
class LotteryBettingMainDetailWidget extends StatefulWidget {
  const LotteryBettingMainDetailWidget({super.key, required this.onValueChanged});

  final ValueChanged<MainMenu> onValueChanged;

  @override
  State<LotteryBettingMainDetailWidget> createState() =>
      _LotteryBettingMainMenuWidgetState();
}

class _LotteryBettingMainMenuWidgetState
    extends State<LotteryBettingMainDetailWidget> {
